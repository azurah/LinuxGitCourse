...
#
# Version 8.8: 2020-09-03 ready-for.sh
#   - Add LFS153x and LFS157x
# 
#===============================================================================
VERSION=8.8
...
PACKAGES[Ubuntu_LFD450]="libpython2-dev libpython3-dev libtool squashfs-tools"
RECOMMENDS[Ubuntu_LFD450]="gcc-arm-linux-gnueabihf libc6-dev-armhf-cross"
PACKAGES[Ubuntu-16.04_LFD450]="-libpython2-dev libpython-dev libtool-bin"
PACKAGES[Ubuntu-18.04_LFD450]="-libpython2-dev libpython-dev"
...
#===============================================================================
# Extra requirements for LFS153x
#===============================================================================
TITLE[LFS153x]="Building Microservice Platforms with TARS"
WEBPAGE[LFS153x]="$LFSTRAINING/building-microservice-platforms-with-tars-lfs153x"
INPERSON[LFS153x]=n
VIRTUAL[LFS153x]=n
SELFPACED[LFS153x]=y
RAM[LFS153x]=2
MOOC[LFS153x]=edX
INTERNET[LFS153x]="$REQUIRED"
#-------------------------------------------------------------------------------
#OS[LFS153x]="$ANYOS"
PACKAGES[LFS153x]="@build @docker @java cmake git golang nodejs php"
PACKAGES[Debian_LFS153x]="default-mysql-server"
PACKAGES[Ubuntu-16.04_LFS153x]="-default-mysql-server mysql-server"
PACKAGES[Fedora_LFS153x]="community-mysql-server"
PACKAGES[CentOS_LFS153x]="mysql-server"
PACKAGES[CentOS-7_LFS153x]="-mysql-server"
PACKAGES[openSUSE_LFS153x]="-golang -nodejs nodejs12 -php"
PACKAGES[openSUSE-15.1_LFS153x]="-nodejs12"

#===============================================================================
# Extra requirements for LFS157x
#===============================================================================
TITLE[LFS157x]="Introduction to Serverless on Kubernetes"
WEBPAGE[LFS157x]="$LFSTRAINING/introduction-to-serverless-on-kubernetes-lfs157x"
INPERSON[LFS157x]=n
VIRTUAL[LFS157x]=n
SELFPACED[LFS157x]=y
CPUS[LFS157x]=2
PREFER_CPUS[LFS157x]=4
BOGOMIPS[LFS157x]=3000
CPUFLAGS[LFS157x]="svm|vmx"
RAM[LFS157x]=8
DISK[LFS157x]=20
ARCH[LFS157x]="x86_64"
DISTRO_ARCH[LFS157x]="x86_64"
DISTROS[LFS157x]="Ubuntu-18.04+LTS"
DISTRO_DEFAULT[LFS157x]="Ubuntu-20.04"
MOOC[LFS157x]=edX
INTERNET[LFS157x]="$REQUIRED"
#-------------------------------------------------------------------------------
PACKAGES[LFS157x]="@docker"
